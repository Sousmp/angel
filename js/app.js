 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".first__slider")) new Swiper(".first__slider", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        slides.forEach((slide => {
            slide.addEventListener("click", (() => {
                if (bodyLockStatus) {
                    const isFullscreen = photoSlider.classList.contains("fullscreen");
                    bodyLockToggle();
                    if (isFullscreen) {
                        photoSlider.classList.remove("fullscreen");
                        slide.classList.remove("fullscreen-slide");
                    } else {
                        photoSlider.classList.add("fullscreen");
        ...
        window.addEventListener("load", (function(e) {
            if (document.querySelector(".swiper-wrapper")) document.querySelector(".swiper-wrapper").style.opacity = "1";
        }));
        class Popup {
            constructor(options) {
                let config = {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            const pageTransition = document.querySelector(".wrapper");
        ...
        function applyZoom() {
            ...
            const zoomElements = document.querySelectorAll(".zoom, .zoom2");
            if (windowWidth > 1200) {
                const zoomFactor = windowWidth / 1200;
                zoomElements.forEach((element => {
                    element.style.zoom = zoomFactor;
                }));
                document.body.style.overflowX = "hidden";
            } else if (windowWidth > 960) {
                const zoomFactor = windowWidth / 960;
                zoomElements.forEach((element => {
                    element.style.zoom = zoomFactor;
                }));
                document.body.style.overflowX = "hidden";
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            async function setupVideoPosters() {
                ...
                videoContainers.forEach((container => {
                    ...
                    if (canvas) {
                        const promise = captureVideoPoster(video, canvas).catch((error => {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            subMenus.forEach((item => {
                originalParents.push(item.parentNode);
            }));
            function moveSubMenuItems() {
                const windowWidth = window.innerWidth;
                if (windowWidth <= 960) Array.from(subMenus).reverse().forEach((item => {
                    menuList.insertBefore(item, menuList.firstChild);
                })); else subMenus.forEach(((item, index) => {
                    originalParents[index].appendChild(item);
                }));
            }
            window.addEventListener("resize", moveSubMenuItems);
            moveSubMenuItems();
        }));
        document.addEventListener("DOMContentLoaded", (function() {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            switches.forEach((switchElement => {
                switchElement.addEventListener("change", (function() {
                    const switchContainer = switchElement.closest(".switch__container");
                    const galleryVideo = switchContainer.closest(".gallery__video");
                    const videoElement = galleryVideo.querySelector("video");
                    const photoContainer = galleryVideo.querySelector(".gallery__video-container");
                    const photoPoster = galleryVideo.querySelector(".gallery__video-poster");
                    if (switchElement.checked) {
                        videoElement.style.display = "none";
                        photoContainer.style.display = "block";
                        if (photoPoster) photoPoster.style.display = "none";
                        switchContainer.classList.add("_active");
                        galleryVideo.classList.add("_active");
                    } else {
                        videoElement.style.display = "block";
                        if (photoPoster) photoPoster.style.display = "block";
                        photoContainer.style.display = "none";
                        switchContainer.classList.remove("_active");
                        galleryVideo.classList.remove("_active");
                    }
                }));
            }));
        }));
        document.addEventListener("DOMContentLoaded", (function() {
            const buttons = document.querySelectorAll(".estate__button");
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            const likeButtons = document.querySelectorAll(".estate__like");
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            tooltipButtons.forEach((button => {
                const tooltipPlate = button.querySelector(".tooltip-plate");
                const elementToShow = tooltipPlate || button;
                ...
                if (tooltipPlate) {
                    tooltipPlate.addEventListener("mouseenter", (function() {
                        clearTimeout(hideTimeout);
                    }));
                    tooltipPlate.addEventListener("mouseleave", (function() {
                        hideTimeout = setTimeout((function() {
                            tooltipPlate.classList.remove("show");
                        }), 400);
                    }));
                }
                button.addEventListener("click", (function(event) {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            forms.forEach((form => {
                ...
                const agreementError = form.querySelector("#agreementError");
                ...
                form.addEventListener("submit", (function(event) {
                    ...
                    if (nameValue === "") {
                        ...
                        isValid = false;
                    } else if (!/^[a-zA-ZА-Яа-яЁё]+$/.test(nameValue)) {
                    ...
                    const unformattedPhoneValue = phoneValue.replace(/\D/g, "");
                    if (phoneValue === "" || phoneValue.includes("_")) {
                        phoneError.textContent = "Введите номер телефона";
                        phoneError.style.display = "block";
                        phoneInput.classList.add("error");
                        isValid = false;
                    } else if (unformattedPhoneValue.length < 10) {
                        phoneError.textContent = "Слишком короткий номер телефона";
                        phoneError.style.display = "block";
                        phoneInput.classList.add("error");
                        isValid = false;
                    } else phoneInput.classList.remove("error");
                    if (!agreementCheckbox.checked) {
                        agreementError.textContent = "Обязательное поле";
                        agreementError.style.display = "block";
                        agreementCheckboxContainer.classList.add("error");
                        isValid = false;
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            if (document.querySelector(".zoom-slider")) {
                ...
                const zoomWrapper = zoomSlider.querySelector(".swiper-wrapper");
                const closeButton = zoomSlider.querySelector(".zoom-slider__close");
                const zoomButton = document.getElementById("zoom-button");
                const zoomArrowLeft = zoomSlider.querySelector(".zoom-slider__arrow-left");
                ...
                if (document.querySelector(".gallery")) page.addEventListener("click", (event => {
                    if (event.target.closest(".gallery__photo")) {
                        ...
                        swiper = new Swiper(".zoom-slider__slider", {
                            modules: [ Zoom, Navigation ],
                            zoom: true,
                            initialSlide: [ ...photos ].indexOf(clickedPhoto),
                            spaceBetween: 10,
                            navigation: {
                                prevEl: ".zoom-slider__arrow-left",
                                nextEl: ".zoom-slider__arrow-right"
                            },
                            on: {
                                doubleTap: function() {
                ...
                zoomButton.addEventListener("click", (() => {
                    if (swiper && swiper.zoom) if (swiper.zoom.scale === 1) {
                        swiper.zoom.in();
